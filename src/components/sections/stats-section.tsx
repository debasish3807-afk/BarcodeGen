...
// ======================
// Stats Section - Premium Gradient Cards with Glow
// ======================
          ...
          {STATS.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative p-6 sm:p-8 md:p-10 rounded-3xl bg-white dark:bg-surface-900/60 border border-surface-200/60 dark:border-surface-700/30 transition-all duration-500 text-center hover:-translate-y-2 hover:shadow-2xl ${statGlows[index % statGlows.length]} cursor-default gradient-border-hover`}
              >
                {/* Animated glow effect */}
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-primary-500/[0.03] via-transparent to-secondary-500/[0.03] opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                ...
                <div className="relative">
                  {/* Large value - better typography hierarchy */}
                  ...
                  {/* Label - smaller, muted */}
                  <p className="mt-3 md:mt-4 text-sm md:text-base text-surface-500 dark:text-surface-400 font-semibold tracking-wide uppercase">
                    {stat.label}
                  </p>
                </div>
              </motion.div>
