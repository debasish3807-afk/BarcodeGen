              ...
              <Link href={`/blog/${post.slug}`} className="group block h-full">
                <div className="h-full flex flex-col overflow-hidden rounded-2xl bg-white dark:bg-surface-900/60 border border-surface-200/60 dark:border-surface-700/30 hover:border-primary-200 dark:hover:border-primary-800/50 hover:shadow-xl hover:shadow-primary-500/[0.05] hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="p-5 md:p-6 flex flex-col flex-1">
                    <span className="inline-flex w-fit px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-primary-700 dark:text-primary-300 bg-primary-50 dark:bg-primary-950/50 rounded-full mb-3">
                      {post.category}
                    </span>
                    <h3 className="text-base font-bold text-surface-900 dark:text-white mb-2 line-clamp-2 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                      {post.title}
                    </h3>
